...
`addPurchaseData(data: Partial<IPurchaseData>): Promise<IPurchaseData>` - использует метод post класса Api для отправки на сервер данных о покупателе и выбранных товарах.